...
public class E1ImpressoraWin
{
    ...
    [DllImport(DLL, CallingConvention = CallingConvention.StdCall)]
    internal static extern int StatusImpressora(int param);
    
    [DllImport(DLL, CallingConvention = CallingConvention.StdCall)]
    internal static extern int DefinePosicao(int posicao);

    [DllImport(DLL, CallingConvention = CallingConvention.StdCall)]
    internal static extern int AbreGavetaElgin();

    [DllImport(DLL, CallingConvention = CallingConvention.StdCall)]
    internal static extern int ImprimeCupomTEF(string dados);    
    
    [DllImport(DLL, CallingConvention = CallingConvention.StdCall)]
    internal static extern int ImpressaoCodigoBarras(int tipo, string dados, int altura, int largura, int hri);

...
public partial class E1Bridge : ComponentBase
{
    ...
    private async void EnviarTransacao()
    {
        ...
        {
            resultado = E1BridgeService.IniciaVendaCredito(GerarNumeroRandomicoParaTransacoes(), _dados.Pdv, _dados.ValorEmCentavos, (int)_dados.TipoParcelamento, _dados.Parcelas);
        }
        else
        {
            resultado = E1BridgeService.IniciaVendaDebito(GerarNumeroRandomicoParaTransacoes(), _dados.Pdv, _dados.ValorEmCentavos);
    ...
    private async void CancelarTransacao()
    {
        ...
        string resultado = E1BridgeService.IniciaCancelamentoVenda(GerarNumeroRandomicoParaTransacoes(), _dados.Pdv, _dados.ValorEmCentavos, todayDate, saleRef);
    ...
    private async void ImprimirCupomTeste()
    {
        ...
        switch (selected)
        {
            case NFCE_COUPON:
                ...
                resultado = E1BridgeService.ImprimirCupomNfce(XML_EXEMPLO_CUPOM_NFCE, INDEXCSC_EXEMPLO, CSC_EXEMPLO);
                break;
            case SAT_COUPON:
                ...
                resultado = E1BridgeService.ImprimirCupomSat(XML_CUPOM_EXEMPLO_SAT);
                break;
            case SAT_CANCELLATION_COUPON:
                ...
                resultado = E1BridgeService.ImprimirCupomSatCancelamento(XML_CUPOM_EXEMPLO_SAT_CANCELAMENTO, ASS_QR_CODE_EXEMPLO);
    ...
    private async void OperacaoAdministrativa()
    {
        ...
        string resultado = E1BridgeService.IniciaOperacaoAdministrativa(GerarNumeroRandomicoParaTransacoes(), _dados.Pdv, index);
    ...
    private async void ConfigurarSenhaTerminal()
    {
        ...
        if (Array.IndexOf(enableOrDisable, option) == 0)
        {
            ...
            string resultado = E1BridgeService.SetSenhaServer(passwordEntered, true);
        ...
        else
        {
            ...
            string resultado = E1BridgeService.SetSenhaServer(string.Empty, false);
            await DialogService.DisplayAlert("Retorno E1-Bridge : Senha do Terminal", resultado);
        }
    }
    ...
    private async void ConfigurarTimeoutTransacoes()
    {
        ...
        string resultado = E1BridgeService.SetTimeout(int.Parse(newTimeoutInSeconds));
    ...
    private async void ConsultarUltimaTransacao()
    {
        ...
        string resultado = E1BridgeService.ConsultarUltimaTransacao(_dados.Pdv);
